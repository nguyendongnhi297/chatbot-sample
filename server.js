...
////var io = require('socket.io').listen(app.listen(3000));  //chat application
...
var adminRouter = require('./route/admin.route');
var themlopRouter = require('./route/themlop.route');
var khoahoc = require('./route/khoahoc');
var khoahocad = require('./route/khoahocad');
var chatbot = require('./route/chatbot.route');
//var test = require('./route/test');
var bodyParser = require('body-parser');
var flash = require('express-flash');
//CSDL
var mysql = require('mysql');
var connection = require('./route/db');
//Session
...
//train the chatbot
//Hỏi sk
manager.addDocument('vi','bạn khỏe?','greetings.health');
//Hỏi tên
manager.addDocument('vi','Tên của  là gì?','greetings.name');
manager.addDocument('vi','Tên của ?','greetings.name');
manager.addDocument('vi','Mình có thể gọi như thế nào?','greetings.name');
//Xin chào
...
//************************************************************************************//
//Sức Khỏe
manager.addAnswer('vi','greetings.health','Mình khoẻ');
//Hỏi tên
...
app.use('/themlop',themlopRouter);
app.use('/trangchu',userRouter);
app.use('/admin/trangchuad',adminRouter);
app.use('/khoahoc',khoahoc)
app.use('/khoahocad',khoahocad)
//app.use('/check',check)
app.use('/dangxuat',function(request, response) {
	request.session.destroy();
	 request.session = null;
		response.redirect('/');
})
server.listen(3000,function(){
console.log('App duoc chay tren cong:3000')
});
//connection.end()
